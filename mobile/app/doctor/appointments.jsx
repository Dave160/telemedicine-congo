      ...
      <View style={{ flexDirection: 'row', padding: 12, gap: 8 }}>
        {[{ v: 'PENDING', l: 'En attente' }, { v: 'CONFIRMED', l: 'Confirmés' }, { v: 'COMPLETED', l: 'Terminés' }, { v: '', l: 'Tous' }].map((s) => (
          <TouchableOpacity
            ...
            style={{ flex: 1, paddingVertical: 6, borderRadius: 20, backgroundColor: filter === s.v ? '#1a73e8' : '#fff', borderWidth: 1, borderColor: filter === s.v ? '#1a73e8' : '#e5e7eb', alignItems: 'center' }}
          >
